...
namespace POS.Web.Controllers
{
    ...
    public class ProductController : Controller
    {
            ...
            CreateProductDto dto, IFormFile? imageFile)
        {
            ...
            // CategoryIds comes from the hidden inputs
            // generated by multi-select.js
            // e.g. CategoryIds=2&CategoryIds=5
            // ASP.NET Core binds them into List<int> automatically
            ...
            try
            {
                ...
                TempData["success"] =
                    $"Product '{dto.Name}' created successfully.";
